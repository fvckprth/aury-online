    ...
    return (
      <div>
        ...
        <p className="text-xs sm:text-sm tracking-wide font-light mt-4">
            ...
            drinking <a href="#" className="underline underline-offset-4 decoration-from-font hover:opacity-25">Old Fashioneds</a>, and cherishing <a href="https:/onlinesoni.com" className="underline underline-offset-4 decoration-from-font hover:opacity-25">Sonia</a>.
        </p>
      </div>
    );
  }
