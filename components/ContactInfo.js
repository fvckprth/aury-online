...
function ContactInfo() {
    ...
    return (
        <div>
            <div>
                <p className="text-xs sm:text-sm tracking-wide font-light mt-4 md:mt-0">Find me:</p>
            ...
            <div>
                <p className="text-xs sm:text-sm tracking-wide font-light mt-4 md:mt-12">Reach me:</p>
                <ul className="list-none pl-5 small-bullet underline underline-offset-4 decoration-from-font">
